...
public class Silhouette {
	...
	public static void test(int elements) {
		...
		StreetArr buildings = new StreetArr();
		try{  
			buildings = new StreetArr(10*elements);
   		}
   		catch(Exception e) {
   			System.out.print(e);
   		}
	...
	public static void driver() {
		...
		StreetArr buildings = new StreetArr();	// Street of length 50 is created
		try{  
			buildings = new StreetArr(50);
   		}
	...
	public static void menu() {
		...
		System.out.print("\nEnter a size for the street (minimum 20): "); int size = scanner.nextInt(); StreetArr buildings = new StreetArr();

    	try{  
			buildings = new StreetArr(size);
	...
	public static void edit(StreetArr buildings){
    ...
    public static void view(StreetArr buildings){
