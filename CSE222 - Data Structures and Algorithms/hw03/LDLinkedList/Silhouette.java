...
public class Silhouette {
	...
	public static void main(String args[]) {
		...
		//test(50);	// tests certain methods and measures the time
		driver();
		menu();
	}
	...
	public static void test(int elements) {
		...
		StreetLDLLs buildings = new StreetLDLLs();
		try{  
			buildings = new StreetLDLLs(10*elements);
   		}
   		catch(Exception e) {
   			System.out.print(e);
   		}
	...
	public static void driver() {
		...
		StreetLDLLs buildings = new StreetLDLLs();	// Street of length 50 is created
		try{  
			buildings = new StreetLDLLs(50);
   		}
	...
	public static void menu() {
		...
		System.out.print("\nEnter a size for the street (minimum 20): "); int size = scanner.nextInt(); StreetLDLLs buildings = new StreetLDLLs();

    	try{  
			buildings = new StreetLDLLs(size);
	...
	public static void edit(StreetLDLLs buildings){
    ...
    public static void view(StreetLDLLs buildings){
