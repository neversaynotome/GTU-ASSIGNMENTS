...
* Dynamically stores "Building"s using ArrayList class.
*/
...
public class StreetArrLs {

	/**
	* Constructor which gets the size parameter.
	* StreetArrLs size is defaulted to minimum value of 20,
	* if exceeded throws an exception.
	* @param streetSize minimum value of 20
	*/

	public StreetArrLs(int streetSize) throws IOException {
	...
	public StreetArrLs() {street = 20;}

	/**
	* Adds the objects to ArrayLists that hold objects. 
	...
	*/
	...
	/**
	* To remove the building in the ArrayList.
	* 
	* @param index Index to remove contents of
	* @param side to left or right of the street?
	*/

	public void remove(int index, boolean side) {
	...
	*/
	...
	private ArrayList<Building> right = new ArrayList<Building>();
	private ArrayList<Building> left = new ArrayList<Building>();
	private int street;
}