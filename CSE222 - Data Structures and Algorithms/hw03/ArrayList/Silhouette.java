...
public class Silhouette {
	...
	public static void test(int elements) {
		...
		StreetArrLs buildings = new StreetArrLs();
		try{  
			buildings = new StreetArrLs(10*elements);
   		}
   		catch(Exception e) {
   			System.out.print(e);
   		}
	...
	public static void driver() {
		...
		StreetArrLs buildings = new StreetArrLs();	// Street of length 50 is created
		try{  
			buildings = new StreetArrLs(50);
   		}
	...
	public static void menu() {
		...
		System.out.print("\nEnter a size for the street (minimum 20): "); int size = scanner.nextInt(); StreetArrLs buildings = new StreetArrLs();

    	try{  
			buildings = new StreetArrLs(size);
	...
	public static void edit(StreetArrLs buildings){
    ...
    public static void view(StreetArrLs buildings){
