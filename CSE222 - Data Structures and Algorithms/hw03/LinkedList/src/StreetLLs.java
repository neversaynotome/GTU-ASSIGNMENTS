...
* Dynamically stores "Building"s using LinkedList class.
*/
...
public class StreetLLs {

	/**
	* Constructor which gets the size parameter.
	* StreetLLs size is defaulted to minimum value of 20,
	* if exceeded throws an exception.
	* @param streetSize minimum value of 20
	*/

	public StreetLLs(int streetSize) throws IOException {
	...
	public StreetLLs() {street = 20;}

	/**
	* Adds the objects to LinkedLists that hold objects. 
	...
	*/
	...
	/**
	* To remove the building in the LinkedList.
	* 
	...
	*/
	...
	private LinkedList<Building> right = new LinkedList<Building>();
	private LinkedList<Building> left = new LinkedList<Building>();
	private int street;
}