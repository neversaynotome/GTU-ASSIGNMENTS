...
public class Silhouette {
	...
	public static void driver() {
		...
		Street buildings = new Street();	// Street of length 50 is created
		try{  
			buildings = new Street(50);
   		}
	...
	public static void menu() {
		...
		System.out.print("\nEnter a size for the street (minimum 20): "); int size = scanner.nextInt(); Street buildings = new Street();

    	try{  
			buildings = new Street(size);
	...
	public static void edit(Street buildings){
    ...
    public static void view(Street buildings){
